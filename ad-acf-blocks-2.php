...
define( 'ADB2__PLUGIN_VERSION', '2.4' );
...
load_plugin_textdomain( 'adblocks2', false, dirname(plugin_basename(__FILE__)) . '/languages/' );
...
function adb2_register_blocks_stuff() {
...
add_action( 'init', 'adb2_register_blocks_stuff' );
